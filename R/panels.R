    ...
    tabPanel(panel_name, {       
      sidebarLayout(
        sidebarPanel(
          ...
          sliderInput(ns("quantity_filter"), paste("Filter minimum quantity", span("IF THE PLOT LOOKS STRANGE, TRY FILTERING", style="color:red"), sep=" "), min=0, max=10000, step=1, value=0), 
